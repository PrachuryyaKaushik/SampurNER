...
*Figure: Entity-anchored Machine Translation: The source dataset is translated both as 'Plain sentence' and 'Entity-anchored sentence' to the target languages. The cleaning process includes the removal of sentences with sentence mismatch, entity-anchor boundaries mismatch (both start and end), and total entity counts mismatch between the source and translated sentences.*
